...
impl Parser {
    ...
    pub fn new(tar_path: &String) -> Result<Parser> {
        ...
        let hint_num_states = ((len + 4095) / 4096) as u32;
        // Following hint based on oetools-20.04's largest layer.
        let hint_num_inodes = (23607.0 / 1329164800.0 * len as f64) as u32;
